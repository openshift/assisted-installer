...
replace (
	...
	github.com/go-jose/go-jose => github.com/go-jose/go-jose/v3 v3.0.4
	...
	github.com/openshift/assisted-service => github.com/openshift/assisted-service v0.0.0-20241213170211-a5016f125538
