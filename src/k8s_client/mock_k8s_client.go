...
import (
	...
	v10 "github.com/openshift/ocs-operator/api/v1"
...
// GetStorageCluster mocks base method.
func (m *MockK8SClient) GetStorageCluster(namespace string) (*v10.StorageCluster, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStorageCluster", namespace)
	ret0, _ := ret[0].(*v10.StorageCluster)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetStorageCluster indicates an expected call of GetStorageCluster.
func (mr *MockK8SClientMockRecorder) GetStorageCluster(namespace interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStorageCluster", reflect.TypeOf((*MockK8SClient)(nil).GetStorageCluster), namespace)
}
